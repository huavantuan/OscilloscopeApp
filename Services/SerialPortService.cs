...
namespace UartReceiver
{
    public sealed class UartOptions
    {
        ...
        public byte Eop { get; set; } = 0xAA;
        public byte Esc { get; set; } = 0x7D;
        public int ExpectedDecodedLength { get; set; } = 165;
        public int CrcOffset { get; set; } = 162;
        public int CrcCount { get; set; } = 161;
        public bool CrcLittleEndian { get; set; } = false;
        public int MaxDecodedPacketSize { get; set; } = 256;
    }
    ...
    // MVVM-friendly: không phụ thuộc UI, chỉ raise event
